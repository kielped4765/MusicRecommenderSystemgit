...
print("Done")
from MusicRecommenderSystem.src import recommenders
from MusicRecommenderSystem.src.api import spotify_client
from . src.api.spotify_client import SpotifyClient
from . src.api.youtube_client import YouTubeClient
from . src.playlist.genorator import PlaylistGenerator
from . src.recommenders.hybrid import HybridRecommender
from . import config
import json

import MusicRecommenderSystem
...
def main():
    ...
    # Initalize recommender and playlist generator
    ...
    while True:
        ...
        if choice == '1':
            ...
            genres = input("Enter genres (comma-seperated, e.g., 'rock.indie'):").split(',')
            ...
            mood_features = {
                'energy': energy,
                'valence': valence,
                'dancability': danceability
            }

            length = int(input("Playtlist length (default 30): ") or 30)
